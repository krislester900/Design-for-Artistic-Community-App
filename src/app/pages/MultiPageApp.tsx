...
import { signIn, signUp, signOut as doSignOut, signInWithGoogle, getCurrentSession, onAuthChange, type AuthUser } from "../services/auth";
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {hasSupabaseEnv && (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-background/80 px-6 py-3 text-sm font-medium text-foreground transition-all hover:border-primary/30 hover:bg-primary/5"
                  >
                ...
                {hasSupabaseEnv && (
                  <div className="flex items-center gap-3 py-2">
                    ...
                    <span className="text-xs uppercase tracking-[0.2em] text-muted-foreground/60">ou</span>
                    <div className="flex-1 border-t border-border/50" />
                  </div>
                )}
