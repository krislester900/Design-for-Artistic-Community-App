-- ============================================================
-- Artéïa - Schéma consolidé pour Supabase
-- A exécuter dans Supabase SQL Editor
-- Correspond au code Flutter actuel
-- ============================================================
...
-- ============================================================
-- Les catégories sont gérées par schema-categories-migration.sql
-- pour éviter les conflits avec les colonnes existantes.
...
-- ============================================================
-- 8. CHAT - CANAUX, MEMBRES, MESSAGES
-- ============================================================
...
do $$
begin
  -- Diagnostic : tables chat existantes
  raise notice 'chat tables: %', (
  ...
  if exists (
    ...
    raise notice 'chat_messages exists. Columns: %', (
    ...
    if not exists (
      ...
      begin
        alter table public.chat_messages add column author_id uuid not null default auth.uid();
...
begin
  ...
  raise notice '✅ Tables: profiles, categories, posts, likes, comments, notifications, follows';
