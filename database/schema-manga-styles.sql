...
CREATE TABLE IF NOT EXISTS ai_manga_styles (
  ...
  description TEXT,
  model_owner TEXT NOT NULL DEFAULT 'rocketdigitalai',
  model_name TEXT NOT NULL DEFAULT 'animagine-xl-4.0',
  model_version TEXT NOT NULL DEFAULT '7af46ee494f1cf196d49a8592737f4eb789e34a5a995751b23a869d19f5dc2ba',
  prompt_template TEXT NOT NULL,
  negative_prompt TEXT DEFAULT '',
  width INTEGER DEFAULT 1024,
  height INTEGER DEFAULT 1024,
  num_inference_steps INTEGER DEFAULT 25,
  guidance_scale DECIMAL(4,2) DEFAULT 6.0,
...
-- Seed data
INSERT INTO ai_manga_styles (name, slug, mangaka, description, model_owner, model_name, model_version, prompt_template, negative_prompt, width, height, style_tags) VALUES
